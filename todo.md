...
- [x] Task 3: LRU storage module + tests
- [x] Task 2: Config module with TTL invalidation + tests
- [x] Task 1: Project scaffolding (package.json, tsconfig, vitest, LICENSE, gitignore)
